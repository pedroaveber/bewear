/** biome-ignore-all lint/suspicious/noConsole: Only for dev purpuses */
...
const products = [
  // Acessórios
  {
    ...
    variants: [
      { color: 'Preta', price: 12_999 },
      { color: 'Branca', price: 12_999 },
    ],
  },
  {
    name: 'Meia Alta',
  ...
  // Calças
  {
    ...
    categoryName: 'Calças',
    variants: [
      { color: 'Bege', price: 15_999 },
      { color: 'Preta', price: 15_999 },
      { color: 'Vinho', price: 15_999 },
    ],
  },
  {
    name: 'Calça Knit',
  ...
  },
  {
    ...
    categoryName: 'Calças',
    variants: [
      { color: 'Bege', price: 13_999 },
      { color: 'Branca', price: 13_999 },
      { color: 'Preta', price: 13_999 },
    ],
  },
  {
    name: 'Calça Jordan',
    ...
    categoryName: 'Calças',
    variants: [
      { color: 'Verde', price: 18_999 },
      { color: 'Preta', price: 18_999 },
      { color: 'Azul', price: 18_999 },
    ],
  },
  ...
  // Jaquetas & Moletons
  {
    ...
    variants: [
      { color: 'Preto', price: 19_999 },
      { color: 'Branco', price: 19_999 },
    ],
  },
  {
    ...
    categoryName: 'Jaquetas & Moletons',
    variants: [
      { color: 'Azul', price: 22_999 },
      { color: 'Bege', price: 22_999 },
    ],
  },
  {
    name: 'Jaqueta Style',
    ...
    categoryName: 'Jaquetas & Moletons',
    variants: [
      { color: 'Marrom', price: 17_999 },
      { color: 'Cinza', price: 17_999 },
    ],
  },
  {
    ...
    categoryName: 'Jaquetas & Moletons',
    variants: [
      { color: 'Azul', price: 25_999 },
      { color: 'Amarela', price: 25_999 },
    ],
  },
  ...
  // Tênis
  {
    ...
    categoryName: 'Tênis',
    variants: [
      { color: 'Preto', price: 79_999 },
      { color: 'Branco', price: 79_999 },
      { color: 'Azul', price: 79_999 },
    ],
  },
  {
    ...
    categoryName: 'Tênis',
    variants: [
      { color: 'Verde', price: 69_999 },
      { color: 'Azul', price: 69_999 },
      { color: 'Preto', price: 69_999 },
    ],
  },
  {
    ...
    categoryName: 'Tênis',
    variants: [
      { color: 'Preto', price: 89_999 },
      { color: 'Branco', price: 89_999 },
    ],
  },
  {
    ...
    categoryName: 'Tênis',
    variants: [
      { color: 'Branco', price: 75_999 },
      { color: 'Preto', price: 75_999 },
      { color: 'Azul', price: 75_999 },
    ],
  },
];
...
async function main() {
  ...
  try {
    ...
    for (const categoryData of categories) {
      ...
      // biome-ignore lint/nursery/noAwaitInLoop: Dev
